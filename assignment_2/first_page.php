...
<body bgcolor="#E5FAFA">
  ...
  <form name="reg" onsubmit = "return formValidation();" method = "post" action = "create_cookie.php">
  ...
  <script>
    function formValidation() {
      ...
      var hobby = document.reg.hobby;
      var foodstyle = document.reg.foodstyle;
      var subject = document.reg.subject;
      if (user_Valid(user)) {
        if (pass_valid(psd)) {
          if (passcon_valid()) {
            if (name_valid(name)) {
