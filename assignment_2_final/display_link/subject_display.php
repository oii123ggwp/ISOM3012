...
function display_subject($selected_subject_list_withImage, $random_subject_link_list)//This function is used to display link and the related image and related subject type name
{
    ...
    for($i = 0; $i < count($selected_subject_list_withImage); $i++)
    {
        ...
        foreach($random_subject_link_list as $index)
        {
            ...
            if ($image_added !== true || $first_add_link === true)
                ...
                echo "<tr><td width = '15%' rowspan = '4'><img src ='".$selected_subject_list_withImage[$i][1]."'width='160' height='120'>";
                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$selected_subject_list_withImage[$i][2]."<br><br><br>";
                echo "</td>";
                echo "<td>";
                echo "<br><br><br>";
                //then we insert the link
                echo "<a href ='".$selected_subject_list_withImage[$i][0][$index]."'>".$selected_subject_list_withImage[$i][0][$index]."</a>";
                echo "</td>";
                echo "</tr>";
